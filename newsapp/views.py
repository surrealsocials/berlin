...
def contact_view_mail(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # You can customize the email sending process as needed
            return render(request, 'contact_success.html')
    else:
        form = ContactForm()
...
def contact(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'contact_success.html',{'cats': cats,'featured_items':articles,'latest':articles,'articles':articles})
    else:
        form = ContactForm()
    return render(request, 'contact.html', {'form': form,'cats': cats,'featured_items':articles,'latest':articles,'articles':articles})
